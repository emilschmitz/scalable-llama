...
| 2026-05-29 | `k0k1o49z68x8iny64lm5q783` | `0.5` (Mix)  | `Llama-3.2-1B-Instruct` | `Twofold (Deterministic + LLM)` | `None` (Scratch) | `curriculum_sprint_diff0.5_simplecat_twofold` | `92cdff3eea723ef5e80cb4095bbd94d3e949848a` | 300 steps, difficulty 0.5 (2 nodes 50% connected/50% unconnected mix), simple cat topic (no paragraph constraints), twofold LLM verifier, env 0.1.14 |
| 2026-05-29 | `kxaclc08vxt37reclkqikexc` | `0.5` (Mix)  | `Llama-3.2-1B-Instruct` | `Deterministic Only` | `None` (Scratch) | `curriculum_sprint_diff0.5_simplecat_noverifier` | `92cdff3eea723ef5e80cb4095bbd94d3e949848a` | 300 steps, difficulty 0.5 (2 nodes 50% connected/50% unconnected mix), simple cat topic (no paragraph constraints), no LLM verifier, env 0.1.14 |
| 2026-05-29 | `g4cbm4s1yebqbl3637gjr9io` | `0` (Easy)   | `Llama-3.2-1B-Instruct` | `Twofold (Deterministic + LLM)` | `None` (Scratch) | `curriculum_sprint_diff0.5_lcg_twofold` | `92cdff3eea723ef5e80cb4095bbd94d3e949848a` | 300 steps, difficulty 0 (LCG 2 sentences, 50% [7,2] requiring silver / 50% [2,3] no silver), twofold LLM verifier, env 0.1.14 |
| 2026-05-29 | `fmyzfwbz9njivo64m7pidywk` | `0` (Easy)   | `Llama-3.2-1B-Instruct` | `Deterministic Only` | `None` (Scratch) | `curriculum_sprint_diff0.5_lcg_noverifier` | `92cdff3eea723ef5e80cb4095bbd94d3e949848a` | 300 steps, difficulty 0 (LCG 2 sentences, 50% [7,2] requiring silver / 50% [2,3] no silver), no LLM verifier, env 0.1.14 |
