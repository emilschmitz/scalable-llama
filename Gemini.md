...
| 2026-06-01 | `a5ni7wga28ks07wzqulih6fu` | `1.00` (Stage 1) | `sprints/Llama-3.2-1B-Instruct` | `Twofold (Deterministic + LLM [Tailored Recipe])` | `None` (Scratch) | `ifeval_stage1_optimized_twofold` | `e8e5153` | 300 steps, Stage 1 optimized verifier with verifier_intent_correlation metric, env 0.1.39 |
| 2026-06-01 | `ztjsdawevhhyt8z27r0oqdgk` | `0.90` (Stage 2) | `sprints/Llama-3.2-1B-Instruct` | `Twofold (Deterministic + LLM [Tailored Recipe])` | `None` (Scratch) | `ifeval_stage2_optimized_twofold` | `e8e5153` | 300 steps, Stage 2 optimized verifier from scratch with verifier_intent_correlation metric, env 0.1.39 |
